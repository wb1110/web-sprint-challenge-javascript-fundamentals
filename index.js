...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// "Nested function is able to access variable internal through closure. Functions are able to reach upstream outside of their scope to obtain values"
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    const animalNamesLower = zooAnimals.map((zooAnimals) => zooAnimals.animal_name.toLowerCase());
    return animalNamesLower;
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    const totalPop = zooAnimals.reduce((accumulator, zooAnimals) => {
